// toda a logica de eventos e gerenciamento de estado e definida dentro do corpo do componente
...
export default function Contador() {
    ...
    return (
        <div className='container'>
            ...
            <div>
                <button onClick={aumentar} className={style.sunButton}>Aumentar</button> {/* onClick: agarra um evento do navegador e chama a funcao aumentar */}
            </div>
            <div>
                <button onClick={diminuir} className={style.subButton} style={{ marginTop: '10px' }}>Diminuir</button>
            </div>
        </div>
    )}
